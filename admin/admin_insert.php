            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box align-items-center justify-content-between p-2">
                        ...
                        <div class="">
                            <span class="mb-sm-0">Add New Admin</span>
                        </div>
                            ...
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                                <div class="row">
                                    ...
                                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4">
                                        ...
                                        <input type="text" class="form-control input-field" id="callsign" name="callsign" required>
                                    </div>
                                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4">
                                    ...
                                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4">
                                        ...
                                        <input type="text" class="form-control input-field" id="comments" name="comments">
                                    </div>
                        </div>

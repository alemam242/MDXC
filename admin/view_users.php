...
<head>
    ...
    <title>User List | MDXC ADI Management System</title>
    ...
    <div id="contentRef" class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box align-items-center justify-content-between p-2">
                        ...
                        <div class="">
                            <span class="mb-sm-0">List of users</span>
                        </div>
                    ...
                    <div class="card">
                        <div class="h6 card-header text-uppercase">
                            User Information Table
                                <a href="insert_user.php" class="float-end btn m-0 bg-gradient-info">Add new user</a>
                        </div>
                        <div class="card-body">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td style='font-size:12px' class='";
                echo ucfirst($row['status']) === 'Active' ? 'bg-success-subtle text-success':'bg-danger-subtle text-danger';
                echo "'>" . ucfirst($row['status']) . "</td>";
                echo "<td>
<a href='update_user.php?id=".$row["id"]."' class='text-info me-3'>
<i class='fas fa-pencil-alt'></i>
</a>
<a href='view_user_data.php?id=".$row["id"]."' class='text-secondary viewBtn'>
